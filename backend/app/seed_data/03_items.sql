...
-- 해당 열만 고치면 된다 — 코드를 몰라도 고칠 수 있게 SQL 에 둔 이유다.
--
...
INSERT INTO items (code, name, item_type, process, process_group, stock_uom, stock_uom_group, phase, shelf_life_days, safety_stock) VALUES
  ('RM-01', '폴리머 베이스',   '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 180,  800),
  ('RM-02', '세라믹 분말',     '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 365,  400),
  ('RM-03', '광학 안료',       '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 365,  150),
  ('RM-04', '보강 섬유',       '원자재', '수입', 'PROCESS', 'M2', 'UOM', '양산', NULL, 600),
  ('RM-05', '접착 수지',       '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산',  44,  250),
  ('RM-06', '방열 첨가제',     '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 365,  200),
  ('RM-07', '차단 필름',       '원자재', '수입', 'PROCESS', 'M2', 'UOM', '양산', NULL, 500),
  ('RM-08', '표면 코팅제',     '원자재', '수입', 'PROCESS', 'L',  'UOM', '양산', 120,  300),
  ('RM-09', '미세 충전재',     '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 365,  350),
  ('RM-10', '유연 가소제',     '원자재', '수입', 'PROCESS', 'L',  'UOM', '양산', 180,  280),
  ('RM-11', '보호 라이너',     '원자재', '수입', 'PROCESS', 'M2', 'UOM', '양산', NULL, 450),
  ('RM-12', '안정화 첨가제',   '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산',  90,  180),
  ('RM-13', '전도성 페이스트', '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산',  60,  120),
  ('RM-14', '기능성 염료',     '원자재', '수입', 'PROCESS', 'KG', 'UOM', '양산', 240,  100),
  ('RM-15', '포장 라미네이트', '원자재', '수입', 'PROCESS', 'M2', 'UOM', '양산', NULL, 700);
